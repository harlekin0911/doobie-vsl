...
object Connect {
    ...
    def main( args : Array[String]) : Unit = {
        ...
        println ( odel5 (xa))
        println ( odel6 (xa))
        println( usingOwnMonad())
    }
    
    def odel0( xa : doobie.util.transactor.Transactor.Aux[IO, Unit]) =  {
    ...
    def odel1( xa : doobie.util.transactor.Transactor.Aux[IO, Unit]) =  {
		    val program2 = sql"select 43 from  SYSIBM.SYSDUMMY1".query[Int].unique
			  val io2 = program2.transact(xa)
			  io2.unsafeRunSync
    }
    def odel2( xa : doobie.util.transactor.Transactor.Aux[IO, Unit]) =  {
		    val program2 = sql"select rand from  SYSIBM.SYSDUMMY1".query[Double].unique
			  val io2 = program2.transact(xa)
			  io2.unsafeRunSync
    }
    def odel3( xa : doobie.util.transactor.Transactor.Aux[IO, Unit]) =  {
    ...
    def odel4( xa : doobie.util.transactor.Transactor.Aux[IO, Unit]) = {
