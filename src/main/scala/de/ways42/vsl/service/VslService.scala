...
object VslService {
 ...
 /**
	 ...
	 */
	def aggregateVertragWithEmptyVers( mv:List[Tvsl001]) : Map[String, VertrVers] = 
	 ...
	 */
	def aggregateVertragWithVers( mv : Map[String, VertrVers], pl : List[Tvsl002])  : Map[String, VertrVers] = 
