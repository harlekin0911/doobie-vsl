...
case class VslDom( tvsl001:Tvsl001, mtvsl002: Map[Short,Tvsl002]) {
  ...
  ( tvsl001.LV_VERTR_STAT_CD == 0 && mtvsl002.find( _._2.LV_VERS_STAT_CD == 0).isEmpty)
  
  // x._2.tvsl001.LV_VERTR_STAT_CD == 0 && x._2.mtvsl002.find( _._2.LV_VERS_STAT_CD == 0).isEmpty
  // x._2.tvsl001.istBfr
  /**
   ...
   * Ist Reserve
   */
  def isReserve : Boolean = tvsl001.isReserve //|| mtvsl002.find( !_._2.isReserve).isEmpty
